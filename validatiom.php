 ...
 */
$helper = $this->helper('MDC\CheckoutStep\Helper\Data');
$loqateKey = $helper->getLoqateKey();
?>
<script>
    var demoLanguage = 'en';
    var demoKeyOverride = "<?php echo $loqateKey ?>";
...
<?php 
	...
	$loaderImage = $block->getViewFileUrl('MDC_Requestbrochure::images/loader-2.gif');
?>
<div class="loading-mask" data-role="loader" style="display:none;">
    <div class="loader">
	<img alt="Loading..." src="<?php echo $loaderImage; ?>">
    </div>
</div>
	...
	<div class="cms-container">
		<div class="ob-form-wrapper">
			...
			<div class="ob-brochure-form">
				<div class="ob-form">
					<div class="product data items for-toggle" data-mage-init='{"mage/tabs": {"openedState": "active","active": 0, "disabled": [2], "disabledState": "disabled"}}'>
							<div class="leftitme item title for-toggle-title active" data-role="collapsible">
								<a class="switch" data-toggle="trigger" href="#myself">For myself</a>
							</div>
							<div class="item title for-toggle-title" data-role="collapsible">
					    ...
					    <div id="myself" class="for-my-main-form item content" data-role="content">
					    	<form action="<?= $this->getUrl('requestbrochure/index/formyself'); ?>" method="post" id="formMyself" enctype="multipart/form-data" class="ob-brochure-form"  data-mage-init='{"validation": {}}'>
					    		...
					    		<div class="ob-contact">
					    			...
					    			<div class="contact-field">
						    			<div class="ob-contact-fields top-fi-main">
						    				<div class="ob-field sel-inp">
						    					...
						    					<div class="input-wrap">
							    					...
							    					<input type="text" name="for-myself-fname" required="true" onkeyup="validateName()" id="for-myself-fname-id" data-msg-required="" maxlength="50">
						    				...
						    				<div class="ob-field">
						    					...
						    					<input type="text" name="for-myself-surname" required="true" onkeyup="validateSname()" id="for-myself-surname-id" data-msg-required="" maxlength="50">
						    			...
						    			<div class="ob-contact-fields tel-em-main">
						    				<div class="ob-field">
						    					...
						    					<input type="text" name="for-myself-no" id="for-myself-no-id">
						    				...
						    				<div class="ob-field">
						    					...
						    					<input type="text" name="for-myself-email" onkeyup="validateEmail()" id="for-myself-email-id">
												<span class="EditingFormErrorLabel" id= "email-span-id" style = "display:none"></span>
					    			...
					    			<div class="ob-contact-fields btm">
					    				<div class="ob-field">
					    					...
					    					<input type="text" name="for-myself-address" id="txtAddress_1" required class="" maxlength="200" searchbox="1" placeholder="Start typing your postcode,street or address" data-msg-required="Please enter a value for this field.">
					    						...
					    						<div class="sel-wrp">
						    						<div class="sel-innr">
								    					<select name="for-myself-surnamhow-did-youe" class="title">
															...
															<option value="SOCIAL">Facebook/Instagram/YouTube</option>
															<option value="CARE">Medical/Care professional</option>
															<option value="WOM">Word-of-mouth recommendation</option>
															<option value="INTERNET">Internet search</option>
															<option value="BROCHURE">Brochure</option>
															<option value="VAN">Van</option>
															<option value="EMAIL">Email</option>
															<option value="RC">Existing/returning customer</option>
									...
									<p class="para">Along with our main brochure would you also like any of our additional publications?</p>
									<div class="ob-contact-fields checkbox-main">
										<div class="ob-field checkbox">
											<input type="checkbox" name="for-myself-sfb-checkbox" id="sfbrochure">
					    					<label class="label" for="sfbrochure">Softer Foods Brochure (All our meals for those with swallowing difficulties)</label>
					    				</div>
										<div class="ob-field checkbox">
					    					<input type="checkbox" name="for-myself-alegn-checkbox" id="alergbrochure">
					    					<label class="label" for="alergbrochure">Information on Allergens & Special Diets Booklet</label>
					    				</div>
					    			</div>
					    			...
					    			<div class="ob-SubmitBtn">
					    				<div class="actions-toolbar">
					    					<div class="primary">
					    						<button type="button" title="Order Brochure" id="btnOrderBrochure" class="action submit primary">Order Brochure</button>	
					    					</div>
					    				</div>
					    			</div>
							    </div>
					    ...
					    <div id="someone" class="som-el-main item content" data-role="content">
					    	<form action="<?= $this->getUrl('requestbrochure/index/forsomeoneelse'); ?>" id="formSomeElse" method="post" enctype="multipart/form-data" class="ob-brochure-form"  data-mage-init='{"validation": {}}'>
					    		<input type="hidden" name="vendor_id" class="input-v-id" value="<?php echo $vendorId ?>" />
					    		<div class="ob-contact">
					    			<h2>Please enter their details</h2>
					    			<div class="contact-field">
						    			<div class="ob-contact-fields top-fi-main">
						    				<div class="ob-field sel-inp">
						    					<div class="input-wrap select-fi">
						    			...
						    			<div class="ob-contact-fields btm">
						    				<div class="ob-field">
						    					...
						    					<input type="text" name="for-someone-else-their-no" id="for-someone-no-id">
									...
									<div class="ob-contact-fields btm">
					    				<div class="ob-field">
					    					...
					    					<input type="text" name="for-someone-else-address" id="txtAddress_2" required class="" searchbox="1" maxlength="200" data-msg-required="Please enter a value for this field.">
					    					<div class="typed"><span></span></div>
					    			...
					    			<div class=" js-ob-AppendPronoun" style="display: none">
							    			<div class="ob-contact-fields top-fi-main">
							    				<div class="ob-field sel-inp">
							    					...
							    					<div class="input-wrap">
								    					...
								    					<input type="text" name="for-someone-else-your-first-name" onkeyup="validateSmname()" id="for-someone-your-fname-id" required="true" data-msg-required="" maxlength="50">
							    				...
							    				<div class="ob-field">
							    					...
							    					<input type="text" name="for-someone-else-your-surname"  onkeyup="validateSsmname()" id="for-someone-your-surname-id" required="true" data-msg-required="" maxlength="50">
							    			...
							    			<div class="ob-contact-fields btm">
							    				<div class="ob-field">
							    					...
							    					<input type="text" name="for-someone-else-your-address" required class="" id="txtAddress_3" maxlength="200" searchbox="2" data-msg-required="Please enter a value for this field.">
							    					<div class="typed"><span></span></div>
									...
									<div class="ob-contact-fields checkbox-main">
										<div class="ob-field checkbox">
											<input type="checkbox" name="for-someone-else-sfb-checkbox" id="sfbrochure1">
					    					<label class="label" for="sfbrochure1">Softer Foods Brochure (All our meals for those with swallowing difficulties)</label>
					    				</div>
										<div class="ob-field checkbox">
					    					<input type="checkbox" name="for-someone-else-alegn-checkbox" id="alergbrochure1">
					    					<label class="label" for="alergbrochure1">Information on Allergens & Special Diets Booklet</label>
					    				</div>
					    			</div>
					    			...
					    			<div class="ob-SubmitBtn">
					    				<div class="actions-toolbar">
					    					<div class="primary">
					    						<button type="button" title="Order Brochure" class="action submit primary" id="sbtnOrderBrochure">Order Brochure</button>	
					    					</div>
					    				</div>
					    			</div>
							    </div>
...
require([ 'jquery', 'jquery/ui'], function($){
    ...
    lqt.AddressValidation = (function () {
        ...
        var demoKey = "<?php echo $loqateKey ?>";
        ...
        function listenForAddress() {
            ...
            controlFinder.listen('populate', function (address) {
				...
				if ($('#txtAddress_1').val() != '' && currentSearchField == 1) {
				...
				if ($('#txtAddress_2').val() != '' && $('#txtAddress_3').val() == '' && currentSearchField == 2) {
					document.getElementById('Address_'+currentSearchField).value = '';
					document.getElementById('Street_'+currentSearchField).value = '';
					document.getElementById('house_no_'+currentSearchField).value = '';
					document.getElementById('house_name_'+currentSearchField).value = '';
				...
				if ($('#txtAddress_3').val() != '' && $('#txtAddress_2').val() != '') {
					document.getElementById('Address_3').value = '';
					document.getElementById('Street_3').value = '';
					document.getElementById('house_no_3').value = '';
					document.getElementById('house_name_3').value = '';
					document.getElementById('Locality_3').value = '';
					document.getElementById('Postcode_3').value = '';
					document.getElementById('County_3').value = '';
					document.getElementById('Address_3').value = address.Line1;
					document.getElementById('Street_3').value = address.Line2;
					document.getElementById('house_no_3').value = address.BuildingNumber;
					document.getElementById('house_name_3').value = address.BuildingName;
					document.getElementById('Locality_3').value = address.City;
					document.getElementById('Postcode_3').value = address.PostalCode;
					document.getElementById('Postcode_3').value = address.PostalCode;
					document.getElementById('County_3').value = address.CountryName;
					document.getElementById('txtAddress_3').value = address.FormattedLine1;
					$('#txtAddress_3').blur();
				}
...
//myself
		  ...
		  if ($('#Address_1').val() == "")
          {
            ...
            $('#Address_1_valid').text('Please enter a value for this field.');
			$("html, body").animate({ scrollTop: 430 }, "slow");  
          }
		  if ($('#Locality_1').val() == "")
          {
            $('#Locality_1_valid').show();
            $('#Locality_1_valid').text('Please enter a value for this field.');     
          }
		  if ($('#Postcode_1').val() == "")
          {
            $('#Postcode_1_valid').show();
            $('#Postcode_1_valid').text('Please enter a value for this field.');     
          }
          });
		  ...
		  $('#btnOrderBrochure').on('click', function() {
            if ($('#for-myself-email-id').val() == "")
          {
            $('#email-span-id').show();
            $('#email-span-id').text('Please enter a value for this field.');    
			$("html, body").animate({ scrollTop: 430 }, "slow"); 
          }
          });

			$('#btnOrderBrochure').on('click', function() {
				if ($('#for-myself-title').val() != "" && $('#for-myself-fname-id').val() != "" && $('#for-myself-surname-id').val() != "" && $('#for-myself-no-id').val() != "" && $('#Address_1').val() != "") {
					$('#btnOrderBrochure').prop("disabled", true);
					$('.loading-mask').css('display', 'block');
					$('#formMyself').submit();
				}
				if ($('#for-myself-no-id').hasClass('mage-error') == true) {
					$('#btnOrderBrochure').prop("disabled", false);
		  ...
		  if ($('#borchure1').prop('checked') == true) {
			if ($('#Address_3').val() == "")
          {
            $('.seaddress').show();
            $('.seaddress').text('Please enter a value for this field.');     
          }
		  if ($('#Locality_3').val() == "")
          {
            $('.secity').show();
            $('.secity').text('Please enter a value for this field.');     
          }
		  if ($('#Postcode_3').val() == "")
          {
            $('.sepostcode').show();
            $('.sepostcode').text('Please enter a value for this field.');     
          }
		  }
          });
//someone else
$('#sbtnOrderBrochure').on('click', function() {
		  ...
		  if ($('#Address_2').val() == "")
          {
            ...
            $('#Address_2_valid').text('Please enter a value for this field.');
			$("html, body").animate({ scrollTop: 430 }, "slow"); 
          }
		  if ($('#Locality_2').val() == "")
          {
            $('#Locality_2_valid').show();
            $('#Locality_2_valid').text('Please enter a value for this field.');     
          }
		  if ($('#Postcode_2').val() == "")
          {
            $('#Postcode_2_valid').show();
            $('#Postcode_2_valid').text('Please enter a value for this field.');     
          }
          });
		  ...
		  $('#sbtnOrderBrochure').on('click', function() {
				if ($('#someone-their-title').val() != "" && $('#for-someone-fname-id').val() != "" && $('#for-someone-surname-id').val() != "" && $('#for-someone-no-id').val() != "" && $('#Address_2').val() != "") { 
					if ($('#borchure1').prop('checked') == true) {
						if ($('#for-someone-your-title').val() != "" && $('#for-someone-your-fname-id').val() != "" && $('#for-someone-your-surname-id').val() != "" && $('#for-someone-your-no-id').val() != "") {			
							$('#sbtnOrderBrochure').prop("disabled", true);
							$('.loading-mask').css('display', 'block');
							$('#formSomeElse').submit(); 
						}
					}   
					if ($('#borchure1').prop('checked') == false) {
						$('#sbtnOrderBrochure').prop("disabled", true);
						$('.loading-mask').css('display', 'block');
						$('#formSomeElse').submit(); 
					}   
				}
				if ($('#for-someone-no-id').hasClass('mage-error') == true) {
					$('#sbtnOrderBrochure').prop("disabled", false);
					$('.loading-mask').css('display', 'none');
				}
			});
			...
			$("#for-myself-no-id").keyup(function(){
				...
				$('#no-span-id').hide();
				if(!/^(\(?(0|\+44)[1-9]{1}\d{1,4}?\)?\s?\d{3,4}\s?\d{3,4})$/.test(number)){
					$('#no-span-id').show();
			...
			$("#for-someone-no-id").keyup(function(){
				...
				$('#someone-no-span-id').hide();
				if(!/^(\(?(0|\+44)[1-9]{1}\d{1,4}?\)?\s?\d{3,4}\s?\d{3,4})$/.test(number)){
					$('#someone-no-span-id').show();
					$('#someone-no-span-id').html("Please ensure this is a valid phone number.")
					return false;
				}
				return true;
			});
...
var emailspanid = document.getElementById('email-span-id');
function validateEmail(){
var email = document.getElementById('for-myself-email-id').value;
if(email.length == 0){
emailspanid.innerHTML = 'Please enter a value for this field.';
return false;
}
if(!email.match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/.)){
emailspanid.innerHTML = 'Please ensure this is a valid email address.';
return false;
}
emailspanid.innerHTML='';
return true;
}
